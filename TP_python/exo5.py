...
with open('TP-Python-population.csv', newline='') as csvfile:
    ...
    print(f"En l'an {save_date_min_pop} la population était au plus bas avec {min_pop} ")
    print(f"En l'an {save_date_max_pop} la population était au plus bas avec {max_pop} ")
